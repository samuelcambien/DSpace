...
public class Group2GroupDAOImpl extends AbstractHibernateDAO<Group2Group> implements Group2GroupDAO {
    ...
    @Override
    public void deleteByParentAndChild(Context context, Group parent, Group child) throws SQLException {
        Query query = createQuery(context, "delete from Group2Group WHERE child=:child AND parent=:parent");
