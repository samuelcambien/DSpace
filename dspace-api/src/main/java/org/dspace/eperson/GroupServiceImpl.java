...
//    protected Group2GroupDAO group2GroupDAO;
    ...
    public List<Group> findAll(Context context, int sortField) throws SQLException
    {
        ...
        return groupDAO.findAll(context, metadataFieldsSort, s);
    }
    ...
    protected void rethinkGroupCache(Context context, boolean flushQueries) throws SQLException {
        ...
        List<Object[]> group2groupResults = groupDAO.nativeSQLQuery(context, "SELECT parent_id, child_id FROM Group2Group", flushQueries);
        for (Object[] group2groupResult : group2groupResults) {
            ...
            ByteBuffer bb = ByteBuffer.wrap((byte[]) group2groupResult[0]);
            UUID parent = new UUID(bb.getLong(), bb.getLong());
            bb = ByteBuffer.wrap((byte[]) group2groupResult[1]);
            UUID child = new UUID(bb.getLong(), bb.getLong());
