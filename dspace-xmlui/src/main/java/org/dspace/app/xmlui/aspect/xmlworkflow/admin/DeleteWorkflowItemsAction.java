        ...
        if(workflowIdentifiers != null){
            for (int workflowIdentifier : workflowIdentifiers) {
                ...
                if (workflowItem != null) {
                    WorkspaceItem workspaceItem = XmlWorkflowServiceImpl.sendWorkflowItemBackSubmission(context, workflowItem, context.getCurrentUser(), "Item sent back to the submisson process by admin", null);
